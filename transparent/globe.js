...
DAT.Globe = function(container, opts){
	...
	var imgDir = opts.imgDir || '/Earth-Globe/transparent/';
	...
	var issMaterial = new THREE.SpriteMaterial({
		map: new THREE.TextureLoader().load('/Earth-Globe/transparent/iss.png'),
		color: 0xffffff,
		fog: true
	});
	...
	function init(){
		...
		uniforms['texture'].value = new THREE.TextureLoader().load('/Earth-Globe/transparent/world.jpg');
