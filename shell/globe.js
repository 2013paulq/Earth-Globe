...
DAT.Globe = function(container, opts){
	...
	var imgDir = opts.imgDir || '/Earth-Globe/shell/';
	...
	var issMaterial = new THREE.SpriteMaterial({
		map: new THREE.TextureLoader().load('/Earth-Globe/shell/iss.png'),
		color: 0xffffff,
		fog: true
	});
	...
	function init(){
		...
		uniforms['texture'].value = new THREE.TextureLoader().load('/Earth-Globe/shell/world.jpg');
