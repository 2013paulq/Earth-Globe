...
DAT.Globe = function(container, opts){
	...
	var imgDir = opts.imgDir || '/Earth-Globe/demograph2/globe/';
	...
	var issMaterial = new THREE.SpriteMaterial({
		map: new THREE.TextureLoader().load('/Earth-Globe/demograph2/iss_icon.png'),
		color: 0xffffff,
		fog: true
	});
	...
	function init(){
		...
		uniforms['texture'].value = new THREE.TextureLoader().load('/Earth-Globe/demograph2/world.jpg');
